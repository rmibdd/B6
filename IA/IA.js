// Internal Audit Department - Shared JS

// HREF navigation within the IA section
const IAFilesLP = "IAFilesLP.html";
const IAPoliciesLP = "IAPoliciesLP.html";
const IAServicesLP = "IAServicesLP.html";
...
(function() {
  ...
  if (filesLink) filesLink.href = IAFilesLP;

  const policiesLink = document.getElementById('policiesLP-link');
  if (policiesLink) policiesLink.href = IAPoliciesLP;

  const servicesLink = document.getElementById('servicesLP-link');
  if (servicesLink) servicesLink.href = IAServicesLP;
